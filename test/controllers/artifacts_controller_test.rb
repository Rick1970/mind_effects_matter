...
class ArtifactsControllerTest < ActionController::TestCase
  ...
  test "should create artifact" do
    assert_difference('Artifact.count') do
      post :create, artifact: { experiment_id: @artifact.experiment_id, key: @artifact.key, name: @artifact.name }
    end
  ...
  test "should update artifact" do
    patch :update, id: @artifact, artifact: { experiment_id: @artifact.experiment_id, key: @artifact.key, name: @artifact.name }
    assert_redirected_to artifact_path(assigns(:artifact))
  end
