...
ActiveRecord::Schema.define(version: 20161229235707) do
  ...
  add_index "artifacts", ["experiment_id"], name: "index_artifacts_on_experiment_id"
  ...
  add_index "experiments", ["tenant_id"], name: "index_experiments_on_tenant_id"
